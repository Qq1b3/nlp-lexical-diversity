...
def tokenize_text(text: str, language: str = 'english') -> List[str]:
    ...
    if nltk:
        try:
            ...
            nltk_lang = 'czech' if language.lower() == 'czech' else 'english'
...
def main():
    ...
    if found:
        ...
        print("Please download the datasets folder (with 'english/' and 'czech/' subfolders) as described in the README, then rerun this script.")
        return
